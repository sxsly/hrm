...
CREATE TABLE `dept`  (
  `id` int(2) NOT NULL AUTO_INCREMENT COMMENT '主键 id 部门编号',
  ...
  `is_del` int(1) NULL DEFAULT 0 COMMENT '是否删除，1：已删除，0：未删除',
...
CREATE TABLE `document`  (
  `id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'id 主键',
  ...
  `creator` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `is_del` int(1) NULL DEFAULT 0 COMMENT '是否删除，1：已删除，0：未删除',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `employee`  (
  `id` int(3) NOT NULL AUTO_INCREMENT COMMENT '员工id，主键',
  `employee_name` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '员工姓名',
  ...
  `position_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '职位',
  `position_id` int(2) NULL DEFAULT NULL COMMENT '职位id',
  ...
  `dept_id` int(2) NULL DEFAULT NULL COMMENT '部门id',
  `dept_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '部门',
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '员工一号', 1, '18337281449', '123456@qq.com', '财务主管', 2, '大学本科', '410922123455', 2, '财务部', '河南省濮阳市', '2020-03-15 22:21:44', 0);
INSERT INTO `employee` VALUES (2, '员工二号', 1, '13167403470', '1825764549@qq.com', '普通职员', 1, '大学本科', '410922123456', 1, '人事部', '广州', '2020-03-17 15:20:40', 0);
INSERT INTO `employee` VALUES (3, '员工三号', 1, '13026644411', 'tom@163.com', '技术总监', 3, '大学本科', '2122520', 4, '技术部', '北京市昌平区', '2020-03-17 15:33:17', 0);
INSERT INTO `employee` VALUES (4, '员工四号', 1, '15652968855', '563931768@qq.com', '前端vue开发', 8, '佛山武馆', '41092212311', 7, '前端部', '广东省佛山市', '2020-03-17 15:35:49', 1);
INSERT INTO `employee` VALUES (5, '员工五号', 1, '15652968855', 'five@163.com', '运维主管', 4, '大学本科', '410922123422', 5, '开发部', '北京市朝阳区', '2020-05-10 19:26:53', 0);
...
CREATE TABLE `notice`  (
  ...
  `notice_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公告名称',
  `notice_content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公告内容',
  `notice_creator` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `is_del` int(1) NULL DEFAULT 0 COMMENT '是否删除，1：已删除，0：未删除',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `position`  (
  `id` int(2) NOT NULL AUTO_INCREMENT COMMENT 'id 主键',
  `position_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '职位名称',
...
CREATE TABLE `user`  (
  `id` int(2) NOT NULL AUTO_INCREMENT COMMENT '主键 自增',
  `real_name` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户姓名',
  ...
  `role_id` int(1) NULL DEFAULT NULL COMMENT '角色Id，1：管理员，2：普通用户',
  `state` int(1) NULL DEFAULT 2 COMMENT '状态，1：已审核 2：未审核',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `is_del` int(1) UNSIGNED NULL DEFAULT 0 COMMENT '是否删除，1：已删除，0：未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `user` VALUES (4, '测试一号', 'test_one', '123456', 2, 2, '2020-03-13 21:44:31', 1);
INSERT INTO `user` VALUES (5, '测试二号', 'test_tow', '123123', 2, 2, '2020-03-13 22:05:22', 1);
